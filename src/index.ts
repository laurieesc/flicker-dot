...
export {
  FRAME_INTERVAL, DOT_R, PITCH, OFFSET,
  VIEWBOX_FULL, VIEWBOX_SMALL, SIZE_FULL, SIZE_SMALL,
  COLS_FULL, COLS_SMALL, DOTS_FULL, DOTS_SMALL,
  DEFAULT_ON, DEFAULT_OFF, SAFE_AREA_INDICES, toSmallFrame,
} from './constants';
