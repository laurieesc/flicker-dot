...
func mixed() -> FlickerGrids {
    (0..<6).map { f in (0..<Flicker.dotsFull).map { i in i == 24 || i % Flicker.colsFull == f % Flicker.colsFull } }
}
